...
export function applyTemplate(templateId: string, response: string): { success: boolean; formatted?: string; error?: string } {
...
export function transformResponse(
  ...
  if (options.escape) result = result.replace(/"/g, '\\"');
